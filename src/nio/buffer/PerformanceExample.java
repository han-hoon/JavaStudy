...
public class PerformanceExample {
    public static void main(String[] args) throws Exception{
        ...
        Path to1 = Paths.get("C:/Temp/bufferTest/nonDirectory/test.png");
        Path to2 = Paths.get("C:/Temp/bufferTest/directory/test.png");

        long size = Files.size(from);

        FileChannel fileChannel_from = FileChannel.open(from);
        FileChannel fileChannel_to1 = FileChannel.open(
                to1, EnumSet.of(StandardOpenOption.CREATE, StandardOpenOption.WRITE) );
        FileChannel fileChannel_to2 = FileChannel.open(
                to2, EnumSet.of(StandardOpenOption.CREATE, StandardOpenOption.WRITE) );
        ...
        fileChannel_from.position(0);       // 파일의 위치를 0으로 설정
